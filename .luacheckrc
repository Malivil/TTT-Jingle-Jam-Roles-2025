...
globals = {
    ...
    -- JJ25 Roles
    "ARMSDEALER_DEAL_STATE_COOLDOWN",
    "ARMSDEALER_DEAL_STATE_DEALING",
    "ARMSDEALER_DEAL_STATE_IDLE",
    "ARMSDEALER_DEAL_STATE_LOSING",
    "ARMSDEALER_DEAL_STATE_LOST",
    "BUTTON_RESET_BLOCK_NONE",
    "BUTTON_RESET_BLOCK_PRESSER",
    "BUTTON_RESET_BLOCK_TRAITORS",
    "CHEF_FOOD_TYPE_BURGER",
    "CHEF_FOOD_TYPE_FISH",
    "CHEF_FOOD_TYPE_HOTDOG",
    "CHEF_FOOD_TYPE_NONE",
    "CHEF_STOVE_STATE_BURNT",
    "CHEF_STOVE_STATE_COOKING",
    "CHEF_STOVE_STATE_DONE",
    "CHEF_STOVE_STATE_IDLE",
    "EVENT_ARMSDEALERDEALT",
    "EVENT_CLONEPLAYERCLONED",
    "EVENT_MINDGOBLIN",
    "EVENT_PUPPETEERDEBUFFED",
    "EVENT_RANDOSWAPPER",
    "EVENT_SAFEKEEPERPICKED",
    "EVENT_THIEFSTOLEN",
    "PUPPETEER_DEBUFF_TYPE_COPYCAT",
    "PUPPETEER_DEBUFF_TYPE_PINATA",
    "PUPPETEER_DEBUFF_TYPE_REDHERRING",
    "PUPPETEER_DEBUFF_TYPE_SPOILSPORT",
    "PUPPETEER_DEBUFF_TYPE_WANDERER",
    "RANDOSWAPPER_WEAPON_ALL",
    ...
    "ROLE_THIEF",
    "ROLE_YORKSHIREMAN",
    "SIBLING_SHARE_MODE_COPY_STEAL",
    "SIBLING_SHARE_MODE_COPY",
    "SIBLING_SHARE_MODE_STEAL",
    "THIEF_STEAL_MODE_PROXIMITY",
    "THIEF_STEAL_MODE_TOOLS",
    "THIEF_STEAL_STATE_COOLDOWN",
    "THIEF_STEAL_STATE_IDLE",
